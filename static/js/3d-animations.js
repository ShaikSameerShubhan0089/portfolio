...
function initializeChatBot() {
    ...
    function getSimpleResponse(message) {
        ...
        if (lowerMessage.includes('project')) {
            return "Sameer has worked on several exciting projects: 1) CarbonSphere AI (Geospatial AI for carbon credits), 2) RISE (AI Clinical Decision Support for Autism), 3) Facial Recognition System, 4) Disease Prediction App, 5) Personal Portfolio Website, 6) IoT Gas Leak Detection, and 7) AutoFeel Car Sentiment Analyzer.";
        }
